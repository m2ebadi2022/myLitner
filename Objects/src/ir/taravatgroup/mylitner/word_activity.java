...
mostCurrent._lbl_answer.setTextColor(((int)0xff8c8c8c));
 //BA.debugLineNum = 76;BA.debugLine="lbl_answer.Text=\"برای دیدن معنی کلیک کنید\"";
mostCurrent._lbl_answer.setText(BA.ObjectToCharSequence("برای دیدن معنی کلیک کنید"));
...
mostCurrent._et_edite_codeing = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Private Label3 As Label  'مترادف";
mostCurrent._label3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Private Label1 As Label  'کدینگ";
