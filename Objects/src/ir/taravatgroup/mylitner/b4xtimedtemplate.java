...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.mylitner.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.mylitner.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public ir.taravatgroup.mylitner.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new ir.taravatgroup.mylitner.anotherprogressbar();
...
public ResumableSub_Show(ir.taravatgroup.mylitner.b4xtimedtemplate parent,ir.taravatgroup.mylitner.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
ir.taravatgroup.mylitner.b4xtimedtemplate parent;
