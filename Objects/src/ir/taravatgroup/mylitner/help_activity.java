...
public class help_activity extends Activity implements B4AActivity{
	public static help_activity mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.taravatgroup.mylitner", "ir.taravatgroup.mylitner.help_activity");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (help_activity).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.taravatgroup.mylitner", "ir.taravatgroup.mylitner.help_activity");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.mylitner.help_activity", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (help_activity) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (help_activity) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (help_activity) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (help_activity) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ButtonWrapper _btn_save_file = null;
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 ...
 //BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"help_layout\")";
mostCurrent._activity.LoadLayout("help_layout",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="Panel1.Color=Main.app_color";
mostCurrent._panel1.setColor(mostCurrent._main._app_color /*int*/ );
 //BA.debugLineNum = 34;BA.debugLine="For Each v As View In Activity.GetAllViewsRecursi";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
{
final anywheresoftware.b4a.BA.IterableList group3 = mostCurrent._activity.GetAllViewsRecursive();
...
_v = (anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(group3.Get(index3)));
 //BA.debugLineNum = 35;BA.debugLine="If v Is Label Then";
if (_v.getObjectOrNull() instanceof android.widget.TextView) { 
 //BA.debugLineNum = 36;BA.debugLine="If (v Is Button) Then";
if ((_v.getObjectOrNull() instanceof android.widget.Button)) { 
 //BA.debugLineNum = 37;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 39;BA.debugLine="Dim lbl As Label = v";
...
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_v.getObject()));
 //BA.debugLineNum = 40;BA.debugLine="lbl.Typeface = Main.app_font";
_lbl.setTypeface((android.graphics.Typeface)(mostCurrent._main._app_font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject()));
 //BA.debugLineNum = 41;BA.debugLine="lbl.TextSize=Main.app_font_size";
_lbl.setTextSize((float) (mostCurrent._main._app_font_size /*int*/ ));
 };
 }
};
 //BA.debugLineNum = 44;BA.debugLine="Label3.TextSize=18";
mostCurrent._label3.setTextSize((float) (18));
 //BA.debugLineNum = 46;BA.debugLine="Label3.Text=Main.loc.Localize(\"main-11\")";
mostCurrent._label3.setText(BA.ObjectToCharSequence(mostCurrent._main._loc /*b4a.example.localizator*/ ._localize("main-11")));
 //BA.debugLineNum = 47;BA.debugLine="Label1.Text=Main.loc.Localize(\"h-1\")";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._main._loc /*b4a.example.localizator*/ ._localize("h-1")));
 //BA.debugLineNum = 48;BA.debugLine="btn_save_file.Text=Main.loc.Localize(\"h-2\")";
mostCurrent._btn_save_file.setText(BA.ObjectToCharSequence(mostCurrent._main._loc /*b4a.example.localizator*/ ._localize("h-2")));
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 68;BA.debugLine="btn_back_Click";
_btn_back_click();
 }else {
...
public static String  _btn_back_click() throws Exception{
 //BA.debugLineNum = 62;BA.debugLine="Private Sub btn_back_Click";
...
public static String  _btn_save_file_click() throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Private Sub btn_save_file_Click";
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private btn_save_file As Button";
mostCurrent._btn_save_file = new anywheresoftware.b4a.objects.ButtonWrapper();
