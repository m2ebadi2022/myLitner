...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.mylitner.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.mylitner.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public ir.taravatgroup.mylitner.b4xfloattextfield _searchfield = null;
...
_searchfield = new ir.taravatgroup.mylitner.b4xfloattextfield();
...
__c.LogImpl("940894495","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(ir.taravatgroup.mylitner.b4xsearchtemplate parent,ir.taravatgroup.mylitner.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
ir.taravatgroup.mylitner.b4xsearchtemplate parent;
