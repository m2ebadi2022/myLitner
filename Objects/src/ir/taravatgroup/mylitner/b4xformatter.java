...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.mylitner.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.mylitner.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public ir.taravatgroup.mylitner.b4xformatter._b4xformatdata  _copyformatdata(ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _data) throws Exception{
ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _d = null;
...
_d = new ir.taravatgroup.mylitner.b4xformatter._b4xformatdata();
...
public ir.taravatgroup.mylitner.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _d = null;
...
ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _data = null;
...
public ir.taravatgroup.mylitner.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (ir.taravatgroup.mylitner.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public ir.taravatgroup.mylitner.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
ir.taravatgroup.mylitner.b4xformatter._b4xformatdata _d = null;
...
_d = (ir.taravatgroup.mylitner.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public ir.taravatgroup.mylitner.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
