...
public static ir.taravatgroup.mylitner.b4xbitset  _createbitset(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
ir.taravatgroup.mylitner.b4xbitset _s = null;
...
_s = new ir.taravatgroup.mylitner.b4xbitset();
...
public static ir.taravatgroup.mylitner.b4xorderedmap  _createorderedmap(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static ir.taravatgroup.mylitner.b4xorderedmap  _createorderedmap2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
ir.taravatgroup.mylitner.b4xorderedmap _m = null;
int _i = 0;
...
_m = new ir.taravatgroup.mylitner.b4xorderedmap();
...
public static ir.taravatgroup.mylitner.b4xset  _createset(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static ir.taravatgroup.mylitner.b4xset  _createset2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
...
_s = new ir.taravatgroup.mylitner.b4xset();
