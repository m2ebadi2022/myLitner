...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.mylitner.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.mylitner.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public ir.taravatgroup.mylitner.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new ir.taravatgroup.mylitner.b4xfloattextfield();
...
__c.LogImpl("932768024","Multiline not supported with password mode.",0);
 };
...
public ir.taravatgroup.mylitner.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((ir.taravatgroup.mylitner.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(ir.taravatgroup.mylitner.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((ir.taravatgroup.mylitner.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (ir.taravatgroup.mylitner.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(ir.taravatgroup.mylitner.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
ir.taravatgroup.mylitner.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((ir.taravatgroup.mylitner.b4xfloattextfield)(this)) == false) { 
