...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ir.taravatgroup.mylitner.b4xcache");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ir.taravatgroup.mylitner.b4xcache.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public ir.taravatgroup.mylitner.b4xorderedmap _data = null;
...
_data = new ir.taravatgroup.mylitner.b4xorderedmap();
...
public ir.taravatgroup.mylitner.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
ir.taravatgroup.mylitner.b4xcache._b4xcacheitem _t1 = null;
...
_t1 = new ir.taravatgroup.mylitner.b4xcache._b4xcacheitem();
...
ir.taravatgroup.mylitner.b4xcache._b4xcacheitem _ci = null;
...
_ci = (ir.taravatgroup.mylitner.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_ci = (ir.taravatgroup.mylitner.b4xcache._b4xcacheitem)(group3.Get(index3));
...
_data._remove /*String*/ ((Object)(((ir.taravatgroup.mylitner.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
